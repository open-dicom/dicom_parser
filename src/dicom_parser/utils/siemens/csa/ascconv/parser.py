...
:class:`~dicom_parser.utils.siemens.data_element.AscconvElement`
...
class AscconvParser:
    ...
    :class:`~dicom_parser.utils.siemens.csa.ascconv.AscconvElement`
    ...
    def assign_list_element(part: str, value, destination: dict):
        ...
        value : Any
            The
            :class:`~dicom_parser.utils.siemens.csa.ascconv.element.AscconvElement`'s
            value
        destination : dict
    ...
    def scaffold_part(
        self, csa_data_element: AscconvElement, part: str, destination: dict
    ) -> dict:
        """
        ...
        Parameters
        ----------
        csa_data_element : AscconvElement
            The source instance
        part : str
            List part's name
        destination : dict
    ...
    def scaffold_listed_key(
        self, csa_data_element: AscconvElement, destination: dict = None
    ) -> dict:
        """
    ...
    def assign_listed_element(
        self, csa_data_element: AscconvElement, destination: dict
    ):
        """
    ...
    def parse(self, csa_data_element: AscconvElement):
        """
